...
public interface BugService {
    ...
    Optional<BugPayload> create(BugCreationRequestPayload bugCreationRequestPayload);
    Optional<BugPayload> update(Long id, BugUpdateRequestPayload bugUpdateRequestPayload);
}
